...
## Tasks completed
- [x] [0-hello_world](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/0-hello_world)
...
julien@ubuntu:/tmp/h$ 
```
- [x] [1-confused_smiley](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/1-confused_smiley)
...
julien@ubuntu:/tmp/h$ 
```
- [x] [2-hellofile](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/2-hellofile)
...
$
```
- [x] [3-twofiles](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/3-twofiles)
...
$
```
- [x] [4-lastlines](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/4-lastlines)
...
_krbfast:*:246:-2:Kerberos FAST Account:/var/empty:/usr/bin/false
```
- [x] [5-firstlines](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/5-firstlines)
...
$
```
- [x] [6-third_line](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/6-third_line)
...
julien@ubuntu:/tmp/h$ 
```
- [x] [7-file](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/7-file)
...
julien@ubuntu:~/shell$
```
- [x] [8-cwd_state](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/8-cwd_state)
	- Write a script that writes into the file ``ls_cwd_content`` the result of the command ``ls -la``.
	- If the file ``ls_cwd_content`` already exists, it should be overwritten. If the file ``ls_cwd_content`` does not exist, create it. <br>
```
...
julien@ubuntu:/tmp/h$ 
```
- [x] [9-duplicate_last_line](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/9-duplicate_last_line)
...
julien@ubuntu:/tmp/h$ 
```
- [x] [10-no_more_js](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/10-no_more_js)
...
julien@ubuntu:/tmp/h$ 
```
- [x] [11-directories](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/11-directories)
...
```
- [x] [12-newest_files](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/12-newest_files)
...
alex@ubuntu:/tmp$
```
- [x] [13-unique](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/13-unique)
...
```
- [x] [14-findthatword](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/14-findthatword)
...
$
```
- [x] [15-countthatword](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/15-countthatword)
...
$ 
```
- [x] [16-whatsnext](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/16-whatsnext)
...
$
```
- [x] [17-hidethisword](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/17-hidethisword)
...
$
```
- [x] [18-letteronly](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/18-letteronly)
...
$
```
- [x] [19-AZ](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/19-AZ)
...
julien@ubuntu:/tmp/0x02$ 
```
- [x] [20-hiago](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/20-hiago)
...
julien@ubuntu:/tmp/0x02$ 
```
- [x] [21-reverse](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/21-reverse)
...
julien@ubuntu:/tmp/0x02$ 
```
- [x] [22-users_and_homes](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/22-users_and_homes)
...
julien@ubuntu:/tmp/0x02$ 
```
- [x] [23-empty_casks](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/23-empty_casks)
...
```
- [x] [24-gifs](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/24-gifs)
...
```
    ...
    julien@production-503e7013:~/shell/fun_with_the_shell$
```
- [x] [25-acrostic](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/25-acrostic)
...
julien@ubuntu:/tmp/0x02$ 
```
- [x] [26-the_biggest_fan](https://github.com/cristian-encalada/holbertonschool-shell/blob/master/io_redirections_and_filters/26-the_biggest_fan)
...
```
- Here is an example with one day of logs of the NASA website (1995).<br>
```
